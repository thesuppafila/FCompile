...
namespace FCompile
{
    ...
    {
        public OldLexer Lexer { get; set; }
        public Token Token { get; set; }

        public OldParser(OldLexer lexer)
        {
            Lexer = lexer;
        ...
        private AST_T ParseDefine()
        {
            string value = Token.Value;
            //Eat((int)TokenType.TOKEN_KEYWORD);
            AST_T ast = new AST_T((int)AST.AST_DEFINITION_TYPE);
            ast.Name = value;
            ast.Value = ParseExpression();
            return ast;
        }
        ...
        public AST_T ParseExpression()
        {
            switch (Token.Type)
            {
                ...
                //case TokenType.TOKEN_KEYWORD: return ParseDefine();
